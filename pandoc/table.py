...
# From https://gist.github.com/rriemann/56017da044861f7dd459dc5ab2f25cb9
...
def tbl_headers(s, delimiter):
    ...
    for i in range(1, len(s)):
        ...
        result.append(inlatex(''))
    result.append(inlatex(delimiter + r'\midrule'))
...
def do_filter(k, v, f, m):
    if k == "Table":
        ...
        # not floating, use longtable
            ...
            table.append(latex(r'\begin{supertabular}[]{%s}' % tbl_alignment(v[1], 'l') + ('\n' r'\toprule')))
        ...
        if caption:
          ...
          table.append(latex(r'\end{supertabular}'))
